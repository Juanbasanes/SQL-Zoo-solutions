...
SELECT name, population/1000000 AS population_million
FROM world
...
SELECT name, ROUND(population/1000000,2) AS millions_people, ROUND(gdp/1000000000,2) AS gdp_billions
FROM world
WHERE continent = 'South America'
...
SELECT name, ROUND(gdp/population,-3) AS gdp_percapita
FROM world
